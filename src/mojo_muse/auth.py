...
class KeyringModuleProvider(BaseKeyringProvider):
...
class KeyringCliProvider(BaseKeyringProvider):
...
def get_keyring_provider() -> BaseKeyringProvider | None:
...
class MuseBasicAuth(MultiDomainBasicAuth):
