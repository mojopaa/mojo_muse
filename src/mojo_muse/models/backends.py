...
from ..utils import expand_env_vars, path_to_url
...
class BuildBackend(ABC):
    ...
    def expand_line(
        self, line: str, expand_env: bool = True
    ) -> str:  # TODO: Why is this?
        return line
...
class MuseBackend(BuildBackend):
