...
def test_link_normalized():
    url = "https://pypi.org/simple"
    normalized = "https://pypi.org/simple"
    assert Link(url).normalized == normalized

    url = "git+https://github.com/pallets/click.git@master"
    normalized = "git+https://github.com/pallets/click.git@master"
    assert Link(url).normalized == normalized

    url = "git+git@github.com:pypa/pip.git"
    normalized = "git+ssh://git@github.com/pypa/pip.git"
    assert Link(url).normalized == normalized
